  ...
  <div class="main_box">
    <div class="roll">
      ...
      <div class="menu">
        <ul>
          <li>
            <router-link to="/rentSale" class="nav-link">
      ...
      <div class="notice">
        ...
        <div class="notice_list">
          <ul>
            <li>
              <span>社区精彩活动，欢迎大家踊跃报名，报名时间…</span>
              <img src="../assets/hot.png" />
            </li>
            <li>
              <span>元宵节，家人聚，起家欢快来分享你的全家照…</span>
              <img src="../assets/hot.png" />
            </li>
          </ul>
        </div>
      ...
      <div class="hot_box">
        <div class="hot">
          <ul>
            <li class="top_">
              <p class="top_title">双11大家都买了哪些东西，看看你在本小区排第几…</p>
            ...
            <li class="left_">
              <div class="left">
                <p class="top_title">家家有本难念经，家庭和睦才是最重要欢迎大家来吐槽…</p>
                <div class="hot_tips">
                  <span>#热点</span>
                  <span>2829阅读</span>
                </div>
